...
class MyDataLoader(Dataset):
    ...
    def __getitem__(self,index):
        ...
        attention_mask_section1=torch.ones((1,value.shape[1],value.shape[1]-prediction_length))
        attention_mask_section2=torch.zeros((1,value.shape[1]-prediction_length,prediction_length))
        attention_mask_section3=torch.eye(prediction_length).reshape(1,prediction_length,prediction_length)
